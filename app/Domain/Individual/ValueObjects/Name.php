...
final class Name
{
    ...
    public function first(): string { return $this->firstName; }
    public function last(): string { return $this->lastName; }
    public function middle(): string { return $this->middleName; }
